...
//void enc28j60_read_buffer(char *buffer, unsigned int len);
//void enc28j60_write_buffer(char *buffer, unsigned int len);

#define	lo8(X)		((X) & 0xFF)
#define	hi8(X)		(((X) & 0xFF00)>>8)


#define ENC28J60_PORT	PORTA
#define ENC28J60_PIN_CS	6
#define ENC28J60_DDR	DDRA
#define ENC28J60_PIN_RESET	7

#define ENC28J60_CS_LO()    asm volatile("cbi %0,%1" :: "I" (_SFR_IO_ADDR (ENC28J60_PORT)), "I" (ENC28J60_PIN_CS))
//ENC28J60_PORT &= ~(1<<ENC28J60_PIN_CS);
#define ENC28J60_CS_HI()    asm volatile("sbi %0,%1" :: "I" (_SFR_IO_ADDR (ENC28J60_PORT)), "I" (ENC28J60_PIN_CS))
//ENC28J60_PORT |= (1<<ENC28J60_PIN_CS);
...
//bank1
#define ENC28J60_REG_ERXFCON   0x38
